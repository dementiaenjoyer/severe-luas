...
do --// main
    ...
    do --// funcs
        ...
        do --// math
            ...
            function calculate_distance_3d(end_pos, origin_pos) --// only call with custom vector plz
            ...
            function cache_object(object)
                ...
                if not storage.cache[object] then
                    ...
                    local to_cache = {
                        ...
                        box_outline = Drawing.new("Square"), --// layer the outline to be at the bottom
        ...
        do --// features
            ...
            do --// visuals
                ...
                for _, player in get_players() do
                    ...
                    if player and character and not is_localplayer(player) then

                        cache_object(player);

                        if storage.cache[player] then

                            local player_cache = storage.cache[player];
                            local esp_root = findfirstchild(character, "HumanoidRootPart");
